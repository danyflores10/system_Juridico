...
export const users: UserRow[] = [
  {
    ...
    status: "Active",
    team: "Platform",
    workspace: ["Consultor Jurídico", "Internal Tools"],
  ...
  },
  {
    ...
    status: "Active",
    team: "People Ops",
    workspace: ["Consultor Jurídico", "Sandbox"],
  ...
  {
    name: "Mia Romberg",
    email: "mia.romberg@consultorjuridico.local",
    role: "Billing Admin",
    status: "Pending invite",
    team: "Finance",
    workspace: ["Consultor Jurídico"],
...
export const filters = {
  ...
  workspace: ["All", "Consultor Jurídico", "Sandbox", "Internal Tools", "Acme Inc."],
};
